...
:Window{xy,w,h,title},
next_button{Point{x_max()-170,0},85,20,"Next point",
[](Address,Address pw){reference_to<Lines_window>(pw).next();}}, //next
quit_button{Point{x_max()-70,0},70,20,"Quit", //quit
[](Address,Address pw){reference_to<Lines_window>(pw).quit();}},
next_x{Point{x_max()-400,0},50,20,"next x:"},
next_y{Point{x_max()-250,0},50,20,"next y:"},
xy_out{Point{100,0},100,20,"current (x,y):"},
color_menu{Point{x_max()-80,50},70,20,Menu::vertical,"color"}, //color
color_button{Point{x_max()-80,50},50,20,"color",
[](Address,Address pw){reference_to<Lines_window>(pw).cmenu_pressed();}},
style_menu(Point{x_max()-80,150},70,20,Menu::vertical,"style"), //style
style_button{Point{x_max()-80,150},50,20,"style",
